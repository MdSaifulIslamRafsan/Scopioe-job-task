        ...
        <div className="lg:flex bg-white p-5 m-5 shadow-2xl gap-24 rounded-xl">
            <div className="lg:w-2/5 space-y-3">
                ...
                <p className="text-sm lg:text-base">
                    ...
                    <Link className="text-[#156BCA]" to={"/"}>Terms of Service</Link> 
                    and 
                    <Link className="text-[#156BCA]" to={'/'}>Privacy Policy</Link>
                </p>
                <div className="hidden border rounded-xl p-1 lg:flex">
                    ...
                    />
                    <button onClick={handleSearchClick} className="btn btn-primary">GO</button>
                </div>
            </div>
            ...
            <div className="lg:hidden border rounded-xl p-1 flex">
                <input 
                    ...
                    value={inputValue}
                    onChange={(e) => setInputValue(e.target.value)}
                    className="outline-none w-full flex-1 px-2 sm:px-4" 
                />
                <button onClick={handleSearchClick} className="btn btn-primary">GO</button>
            </div>
        </div>
